...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, helper, leftIcon, className = '', id, required, ...props }, ref) => {
  ...
  ({ label, error, options, className = '', id, required, ...props }, ref) => {
    ...
    return (
      <div className="w-full">
        ...
        <select ref={ref} id={inputId} required={required} className={`input ${error ? 'border-red-300' : ''} ${className}`} {...props}>
