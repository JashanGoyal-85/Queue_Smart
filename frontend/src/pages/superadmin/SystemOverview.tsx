    ...
    <Layout breadcrumb="System Overview">
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          ...
          <h1 className="mt-1 text-3xl font-extrabold tracking-tight text-[#18201D]">System overview</h1>
            ...
            <div className="space-y-2">
              {[
                ...
                <a key={item.href} href={item.href}
                  className="block w-full text-left px-4 py-3 rounded-xl border border-black/10 hover:bg-[#FFF0E8] hover:border-[#E85D32]/30 text-sm font-semibold text-[#18201D] transition-colors">
                  {item.label}
                </a>
              ))}
            </div>
